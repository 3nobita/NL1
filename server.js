...
app.get('/developer/:id', async (req, res) => {
  try {
    ...
    // Fetch details related to the developer if needed
    // Assuming `details` is related to the developer somehow
...
app.get('/property', async (req, res) => {
  try {
    const allProperties = await Property.find(); // Fetch all properties if needed
